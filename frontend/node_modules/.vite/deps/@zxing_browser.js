import { $t as ArgumentException, Dt as BarcodeFormat_default, F as QRCodeReader, It as NotFoundException, Mt as InvertedLuminanceSource, Nt as LuminanceSource, Pt as HybridBinarizer, Qt as IllegalArgumentException, T as EncodeHintType_default, U as DataMatrixReader, Ut as FormatException, V as ErrorCorrectionLevel, Wt as DecodeHintType_default, Xt as ChecksumException, Zt as BinaryBitmap, bt as IllegalStateException, j as PDF417Reader, k as MultiFormatReader, ot as AztecReader, q as MultiFormatOneDReader, v as Encoder } from "./esm-BM4icsYa.js";
//#region node_modules/@zxing/browser/esm/common/HTMLCanvasElementLuminanceSource.js
...
//#endregion
//#region node_modules/@zxing/browser/esm/common/navigator-utils.js
/**
...
//#endregion
//#region node_modules/@zxing/browser/esm/readers/BrowserCodeReader.js
...
var BrowserCodeReader = function() {
	...
	*/
	function BrowserCodeReader(reader, hints, options) {
		if (hints === void 0) hints = /* @__PURE__ */ new Map();
	...
	BrowserCodeReader.mediaStreamSetTorch = function(track, onOff) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0: return [4, track.applyConstraints({ advanced: [{
	...
	BrowserCodeReader.mediaStreamIsTorchCompatible = function(params) {
		...
		try {
			for (var tracks_1 = __values(tracks), tracks_1_1 = tracks_1.next(); !tracks_1_1.done; tracks_1_1 = tracks_1.next()) {
				...
				if (BrowserCodeReader.mediaStreamIsTorchCompatibleTrack(track)) return true;
			}
		} catch (e_1_1) {
			e_1 = { error: e_1_1 };
		} finally {
	...
	*/
	BrowserCodeReader.getMediaElement = function(mediaElementId, type) {
		...
		if (!mediaElement) throw new ArgumentException("element with id '".concat(mediaElementId, "' not found"));
		if (mediaElement.nodeName.toLowerCase() !== type.toLowerCase()) throw new ArgumentException("element with id '".concat(mediaElementId, "' must be an ").concat(type, " element"));
		return mediaElement;
	};
	/**
	...
	*/
	BrowserCodeReader.createVideoElement = function(videoThingy) {
		if (videoThingy instanceof HTMLVideoElement) return videoThingy;
		if (typeof videoThingy === "string") return BrowserCodeReader.getMediaElement(videoThingy, "video");
	...
	*/
	BrowserCodeReader.prepareImageElement = function(imageSource) {
		...
		if (typeof imageSource === "string") return BrowserCodeReader.getMediaElement(imageSource, "img");
	...
	*/
	...
	BrowserCodeReader.getMediaElementDimensions = function(mediaElement) {
		...
		if (mediaElement instanceof HTMLImageElement) return {
	...
	*/
	BrowserCodeReader.createCaptureCanvas = function(mediaElement) {
		if (!mediaElement) throw new ArgumentException("Cannot create a capture canvas without a media element.");
		if (typeof document === "undefined") throw new Error("The page \"Document\" is undefined, make sure you're running in a browser.");
	...
	BrowserCodeReader.listVideoInputDevices = function() {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					case 0:
						if (!hasNavigator()) throw new Error("Can't enumerate devices, navigator is not present.");
						if (!canEnumerateDevices()) throw new Error("Can't enumerate devices, method not supported.");
	...
	*/
	BrowserCodeReader.releaseAllStreams = function() {
		if (BrowserCodeReader.streamTracker.length !== 0) BrowserCodeReader.streamTracker.forEach(function(mediaStream) {
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					...
					case 1:
						isPlaying = _a.sent();
						if (isPlaying) return [2, true];
						return [2, new Promise(function(resolve, reject) {
							var timeoutId = setTimeout(function() {
								if (BrowserCodeReader.isVideoPlaying(element)) return;
								reject(false);
	...
	*/
	BrowserCodeReader.attachStreamToVideo = function(stream, preview, previewPlayTimeout) {
		if (previewPlayTimeout === void 0) previewPlayTimeout = 5e3;
		return __awaiter(this, void 0, void 0, function() {
			var videoElement;
			return __generator(this, function(_a) {
				switch (_a.label) {
	...
	*/
	BrowserCodeReader._waitImageLoad = function(element) {
		return new Promise(function(resolve, reject) {
			var timeoutId = setTimeout(function() {
				if (BrowserCodeReader.isImageLoaded(element)) return;
	...
	*/
	BrowserCodeReader.checkCallbackFnOrThrow = function(callbackFn) {
		if (!callbackFn) throw new ArgumentException("`callbackFn` is a required parameter, you cannot capture results without it.");
	};
	/**
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					...
					case 3:
						...
						return [2, result];
					case 4:
						if (!receivedPreview) BrowserCodeReader.cleanVideoSource(video);
						return [7];
					case 5: return [2];
				}
			});
	...
	*/
	BrowserCodeReader.prototype.scan = function(element, callbackFn, finalizeCallback) {
		...
		*/
		...
		if (!captureCanvasContext) throw new Error("Couldn't create canvas for visual element scan.");
		...
		var loop = function() {
			...
			try {
				...
				callbackFn(_this.decodeFromCanvas(captureCanvas), void 0, controls);
...
//#endregion
//#region node_modules/@zxing/browser/esm/readers/BrowserAztecCodeReader.js
...
//#endregion
//#region node_modules/@zxing/browser/esm/readers/BrowserMultiFormatOneDReader.js
...
//#endregion
//#region node_modules/@zxing/browser/esm/readers/BrowserDatamatrixCodeReader.js
...
//#endregion
//#region node_modules/@zxing/browser/esm/readers/BrowserMultiFormatReader.js
...
//#endregion
//#region node_modules/@zxing/browser/esm/readers/BrowserPDF417Reader.js
...
//#endregion
//#region node_modules/@zxing/browser/esm/readers/BrowserQRCodeReader.js
...
//#endregion
//#region node_modules/@zxing/browser/esm/writers/BrowserCodeSvgWriter.js
...
var BrowserCodeSvgWriter = function() {
	...
	*/
	function BrowserCodeSvgWriter(containerElement) {
		if (typeof containerElement === "string") {
			...
			if (!container) throw new Error("Could not find a Container element with '".concat(containerElement, "'."));
			this.containerElement = container;
		} else this.containerElement = containerElement;
	}
	/**
	...
	*/
	BrowserCodeSvgWriter.prototype.write = function(contents, width, height, hints) {
		...
		var quietZone = hints && hints.get(EncodeHintType_default.MARGIN) !== void 0 ? Number.parseInt(hints.get(EncodeHintType_default.MARGIN).toString(), 10) : BrowserCodeSvgWriter.QUIET_ZONE_SIZE;
	...
	*/
	BrowserCodeSvgWriter.prototype.renderResult = function(code, width, height, quietZone) {
...
//#endregion
//#region node_modules/@zxing/browser/esm/writers/BrowserQRCodeSvgWriter.js
...
var BrowserQRCodeSvgWriter = function() {
	...
	*/
	BrowserQRCodeSvgWriter.prototype.writeToDom = function(containerElement, contents, width, height, hints) {
		...
		if (containerElement instanceof HTMLElement) containerElement.appendChild(svgElement);
	};
	/**
...
//#endregion
export { BarcodeFormat_default as BarcodeFormat, BrowserAztecCodeReader, BrowserCodeReader, BrowserCodeSvgWriter, BrowserDatamatrixCodeReader, BrowserMultiFormatOneDReader, BrowserMultiFormatReader, BrowserPDF417Reader, BrowserQRCodeReader, BrowserQRCodeSvgWriter, HTMLCanvasElementLuminanceSource };
