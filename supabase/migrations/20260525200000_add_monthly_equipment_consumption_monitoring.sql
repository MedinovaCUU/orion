create table if not exists public.consumo_reactivos_mensual (
  ...
  other_sample_class_count bigint not null default 0,
  serum_count bigint not null default 0,
  urine_count bigint not null default 0,
  csf_count bigint not null default 0,
  whole_blood_count bigint not null default 0,
  plasma_count bigint not null default 0,
  other_sample_type_count bigint not null default 0,
  factory_test_count bigint not null default 0,
  non_factory_test_count bigint not null default 0,
  distinct_barcode_r1_count bigint not null default 0,
  distinct_barcode_r2_count bigint not null default 0,
  distinct_calib_control_name_count bigint not null default 0,
  distinct_lot_number_count bigint not null default 0,
  distinct_pack_ise_sn_count bigint not null default 0,
  last_barcode_r1 text not null default '',
  last_barcode_r2 text not null default '',
  last_calib_control_name text not null default '',
  last_calib_control_lot_number text not null default '',
  last_pack_ise_sn text not null default '',
...
create index if not exists consumo_reactivos_mensual_bucket_month_idx
  on public.consumo_reactivos_mensual (bucket_month desc);

create index if not exists consumo_reactivos_mensual_numero_serie_idx
  on public.consumo_reactivos_mensual (numero_serie);

create index if not exists consumo_reactivos_mensual_test_name_idx
  on public.consumo_reactivos_mensual (test_name);

create index if not exists consumo_reactivos_mensual_modelo_idx
  on public.consumo_reactivos_mensual (modelo);
...
alter table public.consumo_reactivos_mensual enable row level security;
...
drop policy if exists "anon_insert_consumo_reactivos_mensual" on public.consumo_reactivos_mensual;
create policy "anon_insert_consumo_reactivos_mensual"
on public.consumo_reactivos_mensual
for insert
to anon
with check (true);

drop policy if exists "anon_update_consumo_reactivos_mensual" on public.consumo_reactivos_mensual;
create policy "anon_update_consumo_reactivos_mensual"
on public.consumo_reactivos_mensual
for update
to anon
using (true)
...
drop policy if exists "anon_select_consumo_reactivos_mensual" on public.consumo_reactivos_mensual;
create policy "anon_select_consumo_reactivos_mensual"
on public.consumo_reactivos_mensual
for select
to anon
using (true);
